    ...
    public class ArmControllerClassic : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            foreach (UrdfJoint joint in sujJoints) {
                joint.AddComponent<JointStateWriter>();
            }
        ...
        void LateUpdate()
        {
            ...
            {
                sujWrite.states = new float[] { RCM.position.x, RCM.position.y, RCM.position.z,
                ...
                if (isMoving)
                {
                    ...
                    for (int iteration = 0; iteration < maxIterations; iteration++)
                    {
                        for (int i = sujJoints.Count - 1; i >= 0; i--)
                        {
                            ...
                            {
                                prismatic.GetComponent<JointStateWriter>().Write(-(target.position.y - 1.215f));
